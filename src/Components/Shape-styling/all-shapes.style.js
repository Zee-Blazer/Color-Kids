...
export const Triangle = styled.View`
    ...
    border-bottom-color: ${props => props.color ? props.color : props.theme.colors.bg.secondary};
...
export const Square = styled.View`
    ...
    background-color: ${props => props.color ? props.color : props.theme.colors.bg.secondary};
    margin: ${props => props.src === "small" ? "0px 12px" : "0px"}
`;
